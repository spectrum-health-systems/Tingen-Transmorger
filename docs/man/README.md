...
<div align="center">
  ...
  ![RELEASE](https://img.shields.io/badge/Release-R26.4-teal)&nbsp;
...
> ```text
> Name: TingenTransmorger-26.4.7z
> Size: 39.5 MB (41,523,410 bytes)
> SHA256: 209dc85b7e8750d8e66b192d10cc2eb26d300c5efc8df4540014c16785738b53 
> ```
...
```json
{
  ...
  "Directory": {
    ...
    "Tmp": "AppData/Tmp",
    "Reports": "Z:/Transmorger/Reports",
    "ReleaseNotes": "Z:/Transmorger/ReleaseNotes"
  }
}
```

There are two components to the configuration file:
...
* **Admin**  
This mode is used for rebuilding the Transmorger database, and should only be used by administrators.
...
* **ReleaseNotes**  
This is the location for the release notes that will be generated by Transmorger. This can be anywhere, but for organizational purposes I recommend putting it in the parent folder of the `MasterDb`.

### Modifying the configuration file

Open `transmorger.config` file in a text editor.
...
#### Modifying the `Reports` location
...
### Modifying the `ReleaseNotes` location

Modify this component of the configuration file to point to where all Transmorger release notes will be saved.
So this:
...
```json
    "ReleaseNotes": "path/to/release-notes"
```
...or a more real-world example:
...
Put the downloaded reports in the location specified by the `Reports` component of the configuration file.
...
Next, launch Transmorger.

Click the **Rebuild database** button.

![](./Images/TransmorgerManual-RebuildDatabaseButton.png)
...
You can rebuild the master database at any time by following these steps:
...
4. Click the **Rebuild database** button.
